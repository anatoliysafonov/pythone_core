...
class AdressBook(UserDict):
    ...
    def add_record(self, name: str, number: list) -> str:
        if name in self.data:
            self.data[name].add_number(number)
        else:
            number = [Phone(item) for item in number]
            record = Record(name, phones=number)
...
---------------------------------------------------------------------------------------------------------------------
               add  [name] [phone(1)] + ... + [phone(N)]. -> create / add contact with phone numbers
            change  [name] [old_phone] [new_phone]....... -> change replace contact's old phone number wuth new phone numbers 
            delete  [name] [phone(1)] + .... + [phone(N)] -> delete contact's phone number
    ...
    contact delete  [name]............................... -> delete contact with [name ]from adressbook
               cls  ..................................... -> clear console
